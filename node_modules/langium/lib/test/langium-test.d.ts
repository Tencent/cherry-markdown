...
import { CodeAction, DiagnosticSeverity } from 'vscode-languageserver-types';
 ...
 */
export declare function testCodeAction<T extends AstNode = AstNode>(services: LangiumServices): (input: string, diagnosticCode: string, outputAfterFix: string | undefined, options?: ParseHelperOptions) => Promise<CodeActionResult<T>>;
