...
import type { Architecture, ArchitectureServices, Info, InfoServices, Pie, PieServices, Radar, RadarServices, Packet, PacketServices, GitGraph, GitGraphServices, TreeView, TreeViewServices } from '../src/language/index.js';
/**
...
export declare function createTreeViewTestServices(): {
    services: TreeViewServices;
    parse: (input: string) => ParseResult<TreeView>;
};
export declare const treeViewParse: (input: string) => ParseResult<TreeView>;
