...
```
标准图片  ![一条dog#100px](../../example/images/demo-dog.png)
设置图片大小(相对大小&绝对大小)  ![一条dog#10%#50px](../../example/images/demo-dog.png)
设置图片对齐方式：
**左对齐+边框**
![一条dog#auto#100px#left#border](../../example/images/demo-dog.png)
**居中+边框+阴影**
![一条dog#auto#100px#center#B#shadow](../../example/images/demo-dog.png)
**右对齐+边框+阴影+圆角**
![一条dog#auto#100px#right#B#S#radius](../../example/images/demo-dog.png)
**浮动左对齐+边框+阴影+圆角**
![一条dog#auto#100px#float-left#B#S#R](../../example/images/demo-dog.png)
开心也是一天，不开心也是一天
这样就过了两天，汪
```
...
```
这是个演示视频  !video[不带封面演示视频](../../example/images/demo.mp4)
这是个演示视频  !video[带封面演示视频](../../example/images/demo.mp4){poster=../../example/images/demo-dog.png}
...
## 通过快捷按钮修改字体样式
![bubble menu](../../example/images/feature_font.png)
...
![copy and paste](../../example/images/feature_copy.gif)
