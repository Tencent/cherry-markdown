...
export const TOOLBAR_BUTTONS = [
  ...
  'wordCount', 'cursorPosition', 'changeLocale', 'shortcutKey', '|'
];
...
export const SIDEBAR_BUTTONS = [
  'togglePreview', 'export', 'settings', 'fullScreen', 'switchModel', 'mobilePreview', 'copy', 'theme', 'wordCount', 'changeLocale', 'shortcutKey', '|'
];
