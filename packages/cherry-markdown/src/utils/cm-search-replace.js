...
export default class SearchBox {
  ...
  addHtml() {
    ...
    const html = [
      ...
      '<button type="button" action="hide" class="ace_searchbtn_close">',
      ...
      '<button type="button" action="findNext" class="ace_searchbtn next">',
      '<svg width="12" height="12" viewBox="0 0 12 12" fill="none">',
      '<path d="M3 5.5L6 8.5L9 5.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
      '</svg>',
      '</button>',
      '<button type="button" action="findPrev" class="ace_searchbtn prev">',
      '<svg width="12" height="12" viewBox="0 0 12 12" fill="none">',
      ...
      '<span action="toggleReplace" class="ace_button replace_toggle" title="Toggle Replace">-</span>',
