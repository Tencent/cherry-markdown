  ...
  $renderRadarChartCommon(tableObject, options) {
    ...
    const chartOptions = {
      ...
      toolbox: {
        ...
        iconStyle: {
          borderColor: 'var(--toolbar-border, #e1e5e9)',
          borderWidth: 1,
          borderRadius: 4,
          color: 'var(--toolbar-btn-color, #656d76)',
          backgroundColor: 'var(--toolbar-bg, #fff)',
        ...
        emphasis: {
          iconStyle: {
            borderColor: 'var(--primary-color, #3582fb)',
            borderWidth: 2,
            color: 'var(--primary-color, #3582fb)',
            backgroundColor: 'var(--toolbar-btn-hover-bg, #f6f8fa)',
            shadowColor: 'var(--primary-color, #3582fb)',
            shadowBlur: 8,
            shadowOffsetY: 2,
            opacity: 0.9,
          },
