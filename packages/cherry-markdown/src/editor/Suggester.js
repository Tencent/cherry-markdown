 ...
 */
import { SyntaxHookBase as SyntaxBase, allSuggestList, suggesterKeywords } from '@cherry-markdown/engine';
...
class SuggesterPanel {
  ...
  /**
   * 设置编辑器
   * @param {unknown} editor editor interaction adapter supplied by the editor package
   */
  setEditor(editor) {
    this.editor = editor;
  }
