...
//#endregion
//#region src/addons/advance/cherry-tapd-checklist-plugin.js
var v = class extends _ {
	...
	afterMakeHtml(e) {
		return e.replace(/\[[\s|x]\]/g, (e) => e.indexOf("x") > -1 ? " <span class=\"ch-icon ch-icon-check\"></span> " : " <span class=\"ch-icon ch-icon-square\"></span> ");
	}
	rule() {
		return {};
	}
};
r(v, "HOOK_NAME", "tapdCheckList");
//#endregion
export { v as default };
