...
`script-src` 仍仅允许扩展自身资源，无 XSS 入口，与 VS Code 官方 markdown 预览扩展做法一致。 [@RSS1102](https://github.com/RSS1102)([#1748](https://github.com/Tencent/cherry-markdown/pull/1748))([`62d57a9`](https://github.com/Tencent/cherry-markdown/commit/62d57a9cb22059e86163fe1381bbdf4176efa54c))

## 0.3.0

### Minor Changes

- chore: 移除 VSCode 插件预发布（pre-release）流程 [@RSS1102](https://github.com/RSS1102)([#1718](https://github.com/Tencent/cherry-markdown/pull/1718))([`c5fdbdd`](https://github.com/Tencent/cherry-markdown/commit/c5fdbdd55cf43e519a490842beb4f82ccf12aeed))
...
- 更新 `build:vscodePlugin` 脚本，在构建插件前自动先构建核心库依赖 [@RSS1102](https://github.com/RSS1102)([#1706](https://github.com/Tencent/cherry-markdown/pull/1706))([`57ad8c9`](https://github.com/Tencent/cherry-markdown/commit/57ad8c946c3baed9673e53874c9ff6425b2a425d))
...
- refactor(vscodePlugin): 将构建工具从 webpack 迁移到 rspack [@RSS1102](https://github.com/RSS1102)([#1579](https://github.com/Tencent/cherry-markdown/pull/1579))([`68017a4`](https://github.com/Tencent/cherry-markdown/commit/68017a4eec2705c33b4fd28dc7433097f4f06cc7))
